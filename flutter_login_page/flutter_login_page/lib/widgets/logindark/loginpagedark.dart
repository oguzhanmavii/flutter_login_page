...
import 'package:login_viaspa/widgets/logindark/usertoforgotdark.dart';

class ViaspaDark extends StatefulWidget {
  @override
  _ViaspaState createState() => _ViaspaState();
}

class _ViaspaState extends State<ViaspaDark> {
  @override
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              UsertoForgotDark(), //TEXT INPUT, FORGOT PASSWORD, LOGIN BUTTON
